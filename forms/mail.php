...
try {
    ...
    $mail->Username   = 'ajeet.kumar.tiwari@gmail.com';                     //SMTP username
    $mail->Password   = 'C0##ect10n';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
 
    //Recipients
    $mail->setFrom('hi@icheckify.co.in', 'iCheckify Mailer');
    $mail->addAddress('pradeep@icheckify.co.in', 'icheckify');     //Add a recipient email address and name 
   
 
 
    $to = 'hi@icheckify.co.in';
    $name = $_POST["name"];
    $email= $_POST["email"];
    $text= $_POST["message"];
    ...
    $mail->Subject = 'icheckify | Signup form filled';
